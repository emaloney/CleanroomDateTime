...
CleanroomDateTime uses **Swift 4.1** and **requires Xcode 9.3** to compile.
...
This specifies that Carthage use the latest version of CleanroomDateTime that is API-compatible with 2.1.0, i.e. any 2.1.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/emaloney/CleanroomDateTime/releases); there may be a newer version than 2.1.0 that is no longer API-compatible.
