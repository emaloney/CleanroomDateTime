...
**This is the `xcode-8.1` branch of CleanroomDateTime.** It uses **Swift 3.0.1** and **requires Xcode 8.1** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/emaloney/CleanroomDateTime/xcode-8.1/Documentation/API/index.html) provided by CleanroomDateTime using the statement:
...
Want to learn more about CleanroomDateTime? Check out [the README](https://github.com/emaloney/CleanroomDateTime/blob/xcode-8.1/README.md) or [the API documentation](https://rawgit.com/emaloney/CleanroomDateTime/xcode-8.1/Documentation/API/index.html).
